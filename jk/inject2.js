    ...
    <div class="offcanvas-body bg-body-secondary p-4">
        <div class="ekad-width">
            <div class="nota fw-bold mt-2 rounded p-4">
                ...
                <span class="label-salam-note-stripe">Apple Pay dan Google Pay juga diterima.<br>Sila tunggu seketika untuk butang Apple/Google Pay untuk muncul selepas menekan jumlah.</span>
            </div>
            <div>
